...
-- A parent/co-admin can delete a timesheet they generated by accident, any
-- time before it's been marked paid or locked.
...
-- A parent/co-admin can delete the payment record tied to a timesheet they're
-- deleting, as long as it hasn't already been marked paid.
