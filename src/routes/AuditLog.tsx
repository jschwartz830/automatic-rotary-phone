...
export function AuditLog() {
  ...
  return (
    <div className="space-y-4 p-4">
      <h1 className="text-xl font-bold text-gray-900 dark:text-gray-50">Audit Log</h1>
          ...
          {events.map((event) => {
            ...
            return (
              <Card key={event.id}>
                ...
                {expanded && (
                  <div className="mt-3 space-y-2 border-t border-gray-100 pt-3 text-xs dark:border-gray-700">
                    {event.before_json && (
                      <div>
                        <p className="font-medium text-gray-500 dark:text-gray-400">Before</p>
                        <pre className="overflow-x-auto rounded-lg bg-gray-50 p-2 text-gray-700 dark:bg-gray-900 dark:text-gray-300">
                    ...
                    {event.after_json && (
                      <div>
                        <p className="font-medium text-gray-500 dark:text-gray-400">After</p>
                        <pre className="overflow-x-auto rounded-lg bg-gray-50 p-2 text-gray-700 dark:bg-gray-900 dark:text-gray-300">
